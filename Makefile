...
SRCS =	ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c	\
		...
		ft_strnstr.c ft_strrchr.c ft_toupper.c ft_tolower.c ft_calloc.c ft_substr.c	\
		ft_strjoin.c ft_strtrim.c ft_putchar_fd.c ft_split.c ft_itoa.c ft_strmapi.c	\
		ft_striteri.c ft_putendl_fd.c ft_putchar_fd.c ft_putnbr_fd.c ft_putstr_fd.c	
